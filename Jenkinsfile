...
node {
  withEnv(['AZURE_SUBSCRIPTION_ID=9daf9d86-59fc-4bc1-bbcd-dece2f0115df',
    ...
    stage('deploy') {
      ...
      // upload package
      sh "curl -T target/calculator-1.0.war $ftpProfile.url/webapps/ROOT.war -u wecarebackofficeuser:L1tyL2xCHqJTyjgB3xDBaSA83NNA6uBTjhwRiYp9KD4lBJPgX2H4a0q7SAKk"
